  ...
  return (
    <>
      ...
      <div className="footer">
        Lilly does NOT call or charge any fees for hiring at any stage. Be aware of Fraudsters or impersonators asking for the same. In case you are in doubt, or want to report a complaint reach out to legal@lilly.com
      </div>
    </>
  );
};
